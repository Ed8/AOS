    ...
    <body data-spy="scroll" data-target="#main-navbar">
    	...
    	<div class="body">
            ...
            <section id="services-section" class="page text-center" style="padding-top: 10%;">
                ...
                <form method="POST" action="index.php?p=profil">
                    <div class="row">
                        <div class="col-xs-3">
                            <input type="password" class="form-control" placeholder="Ancien mot de passe" name="ancienMotDePasse">
                        </div>
                        <div class="col-xs-3">
                            <input type="password" class="form-control" placeholder="Nouveau mot de passe" name="nouveauMotDePasse">
                        </div>
                        <div class="col-xs-3">
                            <input type="password" class="form-control" placeholder="Confirmation mot de passe" name="confMotDePasse">
                        </div></br></br></br></br>
                         <?php
                            if(isset($messErreurProfil)){
                                echo '<div class="messErreurProfil">';
                                echo $messErreurProfil;
                                echo '</div>';
                            }
                            if(isset($messConfProfil)){
                                echo '<div class="messConfProfil">';
                                echo $messConfProfil;
                                echo '</div>';
                            }
                        ?>   
                        </br></br>
                        <input type="submit" class="btn btn-default" value="Confirmer" name="confMotdePasseForm">
                    </div>
                </form>
